...
const Productos = () => {
  ...
  const fetchData = async () => {
    try {
      ...
      // Ordenar productos por ID antes de establecerlos en el estado
      const sortedProductos = response.data.sort((a, b) => a.id - b.id);
      setProductosRegistro(sortedProductos);
    } catch (error) {
      ...
      <div className='cont2'>
        ...
        <div className='content-form'>
          <form onSubmit={handleSubmit}>
            ...
            <label>
              Cantidad:<br />
              <input type="number" name="cantidad" value={formData.cantidad || ''} onChange={handleChange} /><br/><br/>
              <div className='rerro-content'>
